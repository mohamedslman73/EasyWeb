    <div id="exTab2">
        <ul class="nav nav-tabs">
            <li class="active"><a href="#school" data-toggle="tab">Cities Data</a></li>
        </ul>
        <div class="tab-content ">
            <div class="tab-pane active" id="school">

    <div class="form-body">
        <div class="font-blue-soft"><h3 class="form-section">{{$text}} City</h3></div>
        <br>
        ...
        <div class="form-group">
            <label class="control-label col-md-3">Related Country</label>
            <div class="col-md-9">
    ...
    <br><br>
            ...
            <div class="row">
                ...
                <div class="col-md-offset-3 col-md-9">
                    ...
                    <a href="{{url('/lead/cities')}}" type="button" class="btn default">Cancel</a>
                </div>
            </div>
        </div>
