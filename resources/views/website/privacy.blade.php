...
@section('content')
    <div class="container">
        ...
        <p><strong>Privacy Policy</strong><br /> EasySchools built the EasySchools app as a Free app. This SERVICE is provided by EasySchools at no cost and is intended for use as is.</p>
        ...
        <p>The terms used in this Privacy Policy have the same meanings as in our Terms and Conditions, which is accessible at EasySchools unless otherwise defined in this Privacy Policy.</p>
        ...
        <p>Google Play Services<br /> AdMob<br /> Firebase Analytics<br /> Log Data</p>
        ...
        <p>This Service does not use these &ldquo;cookies&rdquo; explicitly. However, the app may use third party code and libraries that use &ldquo;cookies&rdquo; to collection information and to improve their services. You have the option to either accept or refuse these cookies and know when a cookie is being sent to your device. If you choose to refuse our cookies, you may not be able to use some portions of this Service.</p>
