...
/*//////////// dropdown user login
    ...
    $(".drop-filter-adv").click(function () {
        $(this).parent().find("#dropdown-adv-fil").slideToggle("slow");
    });
    ...
    $(".icon").click(function () {
        $(".sid-menue-r-nav-bar").slideToggle("slow");
    });


    $(".close-sid-menue").click(function () {
        $(".sid-menue-r-nav-bar").hide();
    });
...
//// social media
    ...
    $('.compa').click(function () {
        $(this).hide();
        $(this).parent().find('.compa-sec').show();
    })



    $('.compa-sec').click(function () {
        $(this).hide();
        $(this).parent().find('.compa').show();
    })


    $('.love-bu').click(function () {
        $(this).hide();
        $(this).parent().find('.love-bu2').show();
    })


    $('.love-bu2').click(function () {
        $(this).hide();
        $(this).parent().find('.love-bu').show();
    })
...
$('.js-multii-select').selectToMultiSelect();
$('.js-multi-sselect').selectToMultiSelect();
$('.js-multi-sellect').selectToMultiSelect();
$('.js-multi-seelect').selectToMultiSelect();
$('.js-muulti-select').selectToMultiSelect();
$('.js-multi-selectt').selectToMultiSelect();
$('.js-mmulti-select').selectToMultiSelect();
$('.jss-multi-select').selectToMultiSelect();
$('.js-mu55lti-selectt').selectToMultiSelect();
