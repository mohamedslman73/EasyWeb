...
(function() {
  ...
  MT("linkImage",
     "[link [[][tag ![[foo]]][string&url (https//example.com/)][link ]]][string&url (https//example.com/)] bar");
  ...
  MT("linkEmStrong",
     "[link [[][link&strong **][link&em&strong *foo**][link&em *][link ]]][string&url (https//example.com/)] bar");

  // Image with title
  MT("imageTitle",
     "[tag ![[foo]]][string&url (https//example.com/ \"bar\")] hello");

  // Image without title
  MT("imageNoTitle",
     "[tag ![[foo]]][string&url (https//example.com/)] bar");
