...
defaultOptions = {
	...
	global: {
		useUTC: true,
		//timezoneOffset: 0,
		canvasToolsURL: 'https//code.highcharts.com/stock/2.1.9/modules/canvas-tools.js',
		VMLRadialGradientURL: 'https//code.highcharts.com/stock/2.1.9/gfx/vml-radial-gradient.png'
	},
	chart: {
		//animation: true,
		//alignTicks: false,
...
defaultPlotOptions.column = merge(defaultSeriesOptions, {
	...
	softThreshold: false,
	startFromThreshold: true, // docs (but false doesn't work well): https//jsfiddle.net/highcharts/hz8fopan/14/
