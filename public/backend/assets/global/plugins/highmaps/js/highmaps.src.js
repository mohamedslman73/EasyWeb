...
defaultOptions = {
	...
	global: {
		useUTC: true,
		//timezoneOffset: 0,
		canvasToolsURL: 'https//code.highcharts.com/maps/1.1.9/modules/canvas-tools.js',
		VMLRadialGradientURL: 'https//code.highcharts.com/maps/1.1.9/gfx/vml-radial-gradient.png'
	},
	chart: {
		//animation: true,
		//alignTicks: false,
