...
### Manual download
Use **https//vitalets.github.io/x-editable**
...
## Reporting issues
When creating issues please provide [jsFiddle](https//jsfiddle.net) example. You can easily fork one of following:   
1. [jsFiddle bootstrap template](https//jsfiddle.net/xBB5x/1817)  
2. [jsFiddle jqueryui template](https//jsfiddle.net/xBB5x/196)  
3. [jsFiddle jquery template](https//jsfiddle.net/xBB5x/197)    
...
To make it easy follow this script ( _assuming you have [nodejs](https//nodejs.org) installed_ ).
...
To test the result go to **playground**, start server <code>node server.js</code> and open in your browser [https//localhost:3000/playground](https//localhost:3000/playground).
