...
/**
Typeahead input (bootstrap only). Based on Twitter Bootstrap [typeahead](https//twitter.github.com/bootstrap/javascript.html#typeahead).  
...
//                i = $(that.options.item).attr('data-value', item)
    ...
    Constructor.defaults = $.extend({}, $.fn.editabletypes.list.defaults, {
        ...
        **/         
        tpl:'<input type="text">',
        /**
        Configuration of typeahead. [Full list of options](https//twitter.github.com/bootstrap/javascript.html#typeahead).
