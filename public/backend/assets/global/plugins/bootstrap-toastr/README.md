...
## NuGet Gallery
https//nuget.org/packages/toastr
...
To build the minified and css versions of Toastr you will need [node](https//nodejs.org) installed.

Install the [Grunt](https//gruntjs.com/) command line. This might require `sudo`.
...
## Copyright
Copyright © 2012-2014 [Hans Fjällemark](https//twitter.com/hfjallemark) & [John Papa](https//twitter.com/John_Papa).
